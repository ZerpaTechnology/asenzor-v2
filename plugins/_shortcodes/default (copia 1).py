...
class Plugin:
	...
	def __init__(self,modelos):
		...
		for w in os.listdir(global_config.base_root+global_config.plugins_folder+__name__+"/widgets"):
		...
		for elem in config.shortcodes:
			self.shortcodes[elem]=imp.load_source(elem+"_model","../plugins/"+__name__+"/shotcodes/"+elem+".py").shortcode(
