"use strict";
// Transcrypt'ed from Python, 2017-12-22 23:10:55
function decode () {
    ...
    */
	...
	(function () {
		...
		var Decodificador = __class__ ('Decodificador', [object], {
			__module__: __name__,
			get __init__ () {return __get__ (this, function (self) {
				// pass;
			});},
			get decode () {return __get__ (this, function (self, cadena) {
		...
		__pragma__ ('<all>')
			__all__.Decodificador = Decodificador;
			__all__.__name__ = __name__;
		__pragma__ ('</all>')
	}) ();
   return __all__;
