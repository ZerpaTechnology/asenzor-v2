"use strict";
// Transcrypt'ed from Python, 2018-01-09 19:56:18
function Widget () {
					...
					var Widget = __class__ ('Widget', [object], {
						...
						get clone () {return __get__ (this, function (self, target) {
							var copy = function (objeto) {
								if (__in__ ('__class__', dir (objeto))) {
									var o = objeto.__proto__.constructor ();
									var __iterable0__ = dir (o);
									for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
										var elem = __iterable0__ [__index0__];
										if ( typeof getattr(o,elem)!='function'
										) {
											setattr (o, elem, getattr (objeto, elem));
										}
									}
								}
								else {
									var o = Object.create (objeto);
								}
								return o;
							};
							var clon = copy (target);
							return clon;
						});},
						get __update__ () {return __get__ (this, function (self) {
							...
							if (self.children != list ([])) {
								...
								for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
									var elem = __iterable0__ [__index0__];
									self.target.find (self.content (self)).append (elem);
								}
							}
						});},
						...
						get reload () {return __get__ (this, function (self, data) {
							if (typeof data == 'undefined' || (data != null && data .hasOwnProperty ("__kwargtrans__"))) {;
								var data = list ([]);
							};
							$ (self.target).html (self._html.format (data));
						});},
