"use strict";
// Transcrypt'ed from Python, 2018-01-20 15:47:37
function Window () {
		...
		'InsertColumns', {
			__all__: {
				...
				__init__: function (__all__) {
					...
					var Widget = __init__ (__world__.Widget).Widget;
					var BasicTabs = __init__ (__world__.BasicTabs).BasicTabs;
					__nest__ (py_datos, '', __init__ (__world__.py_datos));
					...
					var InsertColumns = __class__ ('InsertColumns', [Widget], {
						...
						get py_update () {return __get__ (this, function (self) {
							self.format = list ([self._titulo]);
							self.__update__ ();
							var __iterable0__ = list (self._columns);
							for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
								var elem = __iterable0__ [__index0__];
								var img = $ ('<img>');
							...
							self.py_new = self.target.find ('>.header').find ('>.btns').find ('>.btns-left').find ('>.new');
							self.__load = self.target.find ('>.header').find ('>.btns').find ('>.btns-left').find ('>.load');
							self.py_new.on ('click', self.tabNew);
